...
## Channel post auto-engagement

When any post is made to a channel where the bot is installed, it automatically responds with 3 random historical posts and an ad:
...
<Note>
This handler triggers on ANY channel post, automatically adding engagement content and tracking new channels.
</Note>

### Auto-channel tracking

If the channel is not already in the tracking list, it's automatically added:
...
This ensures that any channel where the bot is added automatically becomes part of the distribution network.
